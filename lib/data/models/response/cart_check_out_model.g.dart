...
_$_CustomerOrderModel _$$_CustomerOrderModelFromJson(
    ...
    _$_CustomerOrderModel(
      ...
      childrenOperations: json['childrenOperations'],
...
_$_LineItemModel _$$_LineItemModelFromJson(Map<String, dynamic> json) =>
    _$_LineItemModel(
      ...
      taxTotal: (json['taxTotal'] as num?)?.toDouble(),
      taxPercentRate: (json['taxPercentRate'] as num?)?.toDouble(),
      reserveQuantity: (json['reserveQuantity'] as num?)?.toDouble(),
...
Map<String, dynamic> _$$_LineItemModelToJson(_$_LineItemModel instance) =>
    <String, dynamic>{
