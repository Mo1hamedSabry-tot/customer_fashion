...
part of 'cart_check_out_model.dart';
...
CartCheckOutResponseModel _$CartCheckOutResponseModelFromJson(
    Map<String, dynamic> json) {
  return _CustomerOrderModel.fromJson(json);
}

/// @nodoc
mixin _$CartCheckOutResponseModel {
  ...
  List<LineItemModel>? get items => throw _privateConstructorUsedError;
  List<dynamic>? get shipments => throw _privateConstructorUsedError;
  dynamic get feeDetails => throw _privateConstructorUsedError;
  ...
  dynamic get languageCode => throw _privateConstructorUsedError;
  String? get operationType => throw _privateConstructorUsedError;
  dynamic get parentOperationId => throw _privateConstructorUsedError;
  ...
  dynamic get childrenOperations => throw _privateConstructorUsedError;
  ...
  @JsonKey(ignore: true)
  $CartCheckOutResponseModelCopyWith<CartCheckOutResponseModel> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CartCheckOutResponseModelCopyWith<$Res> {
  factory $CartCheckOutResponseModelCopyWith(CartCheckOutResponseModel value,
          $Res Function(CartCheckOutResponseModel) then) =
      _$CartCheckOutResponseModelCopyWithImpl<$Res, CartCheckOutResponseModel>;
  @useResult
  $Res call(
      {String? rowVersion,
      String? customerId,
...
/// @nodoc
class _$CartCheckOutResponseModelCopyWithImpl<$Res,
        $Val extends CartCheckOutResponseModel>
    implements $CartCheckOutResponseModelCopyWith<$Res> {
  _$CartCheckOutResponseModelCopyWithImpl(this._value, this._then);
...
class __$$_CustomerOrderModelCopyWithImpl<$Res>
    extends _$CartCheckOutResponseModelCopyWithImpl<$Res, _$_CustomerOrderModel>
...
/// @nodoc
@JsonSerializable()
class _$_CustomerOrderModel implements _CustomerOrderModel {
  ...
  @override
  final dynamic childrenOperations;
  @override
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality().equals(other.parentOperationId, parentOperationId) &&
            ...
            const DeepCollectionEquality().equals(other.childrenOperations, childrenOperations) &&
  ...
  int get hashCode => Object.hashAll([
        ...
        operationType,
        const DeepCollectionEquality().hash(parentOperationId),
        number,
        isApproved,
        status,
        ...
        const DeepCollectionEquality().hash(childrenOperations),
        cancelledState,
        isCancelled,
...
abstract class _CustomerOrderModel implements CartCheckOutResponseModel {
  const factory _CustomerOrderModel(
      ...
      final String? createdBy,
      final String? modifiedBy,
      final String? id}) = _$_CustomerOrderModel;
  ...
  dynamic get outerId;
  @override
  dynamic get childrenOperations;
  @override
...
mixin _$LineItemModel {
  ...
  double? get taxTotal => throw _privateConstructorUsedError;
  double? get taxPercentRate => throw _privateConstructorUsedError;
  double? get reserveQuantity => throw _privateConstructorUsedError;
  ...
  dynamic get taxDetails => throw _privateConstructorUsedError;
  String? get createdDate => throw _privateConstructorUsedError;
  String? get modifiedDate => throw _privateConstructorUsedError;
  String? get createdBy => throw _privateConstructorUsedError;
  String? get modifiedBy => throw _privateConstructorUsedError;
...
/// @nodoc
abstract class _$$_LineItemModelCopyWith<$Res>
    implements $LineItemModelCopyWith<$Res> {
  factory _$$_LineItemModelCopyWith(
          _$_LineItemModel value, $Res Function(_$_LineItemModel) then) =
      __$$_LineItemModelCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String? priceId,
...
/// @nodoc
class __$$_LineItemModelCopyWithImpl<$Res>
    extends _$LineItemModelCopyWithImpl<$Res, _$_LineItemModel>
    implements _$$_LineItemModelCopyWith<$Res> {
  __$$_LineItemModelCopyWithImpl(
      _$_LineItemModel _value, $Res Function(_$_LineItemModel) _then)
      : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$_LineItemModel implements _LineItemModel {
  const _$_LineItemModel(
      {this.priceId,
      this.currency,
      this.price,
      this.priceWithTax,
  ...
  factory _$_LineItemModel.fromJson(Map<String, dynamic> json) =>
      _$$_LineItemModelFromJson(json);
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.taxDetails, taxDetails) &&
  ...
  int get hashCode => Object.hashAll([
        ...
        const DeepCollectionEquality().hash(taxDetails),
        createdDate,
        modifiedDate,
        createdBy,
        modifiedBy,
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_LineItemModelCopyWith<_$_LineItemModel> get copyWith =>
      __$$_LineItemModelCopyWithImpl<_$_LineItemModel>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_LineItemModelToJson(
      this,
    );
  }
}
...
abstract class _LineItemModel implements LineItemModel {
  const factory _LineItemModel(
      ...
      final String? createdBy,
      final String? modifiedBy,
      final String? id}) = _$_LineItemModel;

  factory _LineItemModel.fromJson(Map<String, dynamic> json) =
      _$_LineItemModel.fromJson;
